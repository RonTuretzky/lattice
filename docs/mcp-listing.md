...
https://github.com/fractal-agentics/lattice
...
| Repository | https://github.com/fractal-agentics/lattice |
| Transport | stdio |
...
```markdown
- [Lattice](https://github.com/fractal-agentics/lattice) 🐍 🏠 🍎 🪟 🐧 - File-based, agent-native task tracker with event-sourced core. 15 tools for full task lifecycle management with actor attribution, relationship graphs, and configurable workflows.
```
...
| Issues | https://github.com/fractal-agentics/lattice/issues |
| Author | [Fractal Agentics](https://fractalagentics.com) |
| License | MIT |
